                        ...
                        <div class="card">
                            ...
                            <div class="card-body pb-0">
                                <div class="form-group">
                                    <label>Nama</label>
                                    <input type="text" name="name"  id="name" class="form-control" value="{{ $mahasiswa->user->name }}" required="">
                                ...
                                <div class="form-group">
                                    <label>Email</label>
                                    <input type="email" name="email"  id="email" class="form-control" value="{{   $mahasiswa->user->email }}" required="">
                                    <div class="invalid-feedback">
                                        Please fill in the field
                                    </div>
                                </div>
